...
" following configs are added to support perl format from
...
:set dictionary+=/usr/share/dict/test
...
" To move cursor to where we left last
au BufWinLeave * mkview
au BufWinEnter * silent loadview

" Syntastic error and warning hilighting
